...
Tags: admin, admin builder, custom admin panel, custom admin pages, option, user meta, post meta, gutenberg, classic editor
...
URI: https://wp-adminbuilder.com/enable-classic-editor/
...
2. Page edition without Gutenberg: screenshot-2.png
3. Widget management without Gutenberg: screenshot-3.png
