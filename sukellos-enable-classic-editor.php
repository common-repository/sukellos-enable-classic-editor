<?php
/**
 * Plugin Name: Sukellos - Enable Classic Editor
 * Plugin URI: https://wp-adminbuilder.com/enable-classic-editor/
 * Description: Sukellos Framework Tools - Enable Classic Editor
 * Version: 1.1.8
 ...
 *
 * Copyright: (c) 2021-2024 Sukellos, SARL (ludovic.maillet@sukellos.fr)
 *
 *
 * @package   WP-Sukellos-Disable-Gutenberg
 * @author    Sukellos
 * @category  Admin
 * @copyright Copyright (c) 2021-2024 Sukellos, SARL
 * @license   Private
 */
...
// Sukellos Framework
use Sukellos\Admin\WP_Sukellos_Enable_Classic_Editor_Admin;
 ...
 * @since 1.0.0
 */
final class WP_Sukellos_Enable_Classic_Editor_Loader extends WP_Sukellos_Fw_Loader {
    ...
    public function get_plugin() {
        ...
        return WP_Sukellos_Enable_Classic_Editor::instance();
    }
    ...
    public function get_plugin_admin() {
        ...
        return WP_Sukellos_Enable_Classic_Editor_Admin::instance();
    }
}
WP_Sukellos_Enable_Classic_Editor_Loader::instance();